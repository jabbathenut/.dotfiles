...
* Language Formatting: [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim)
    * Formatters include: clang-format, cmake-format and stylua
* Language Diagnostics: [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint)
