...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(event)
		...
		wk.add({
			...
			{ "<leader>ld", snacks.picker.lsp_definitions, desc = "Go to Definition" },
			{ "<leader>lD", snacks.picker.lsp_declarations, desc = "Go to Declaration" },
			{ "<leader>lf", vim.lsp.buf.format, desc = "Format" },
			{ "<leader>lh", vim.lsp.buf.hover, desc = "Hover Documentation" },
			{ "<leader>li", snacks.picker.lsp_implementations, desc = "Go to Implementation" },
			{ "<leader>lO", snacks.picker.lsp_symbols, desc = "Document Symbols" },
			{ "<leader>lr", vim.lsp.buf.rename, desc = "Rename" },
			{ "<leader>lR", snacks.picker.lsp_references, desc = "Go to References" },
			{ "<leader>ls", vim.lsp.buf.signature_help, desc = "Signature Help" },
			{ "<leader>lt", snacks.picker.lsp_type_definition, desc = "Go to Type Definition" },
			{ "<leader>lW", snacks.picker.lsp_workspace_symbols, desc = "Workspace Symbols" },
		})
